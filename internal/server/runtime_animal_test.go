...
func TestRuntimeEntityRegistryContainsImplementedEntities(t *testing.T) {
	wantNames := []string{"minecraft:acacia_boat", "minecraft:arrow", "minecraft:bamboo_raft", "minecraft:bat", "minecraft:birch_boat", "minecraft:cherry_boat", "minecraft:chicken", "minecraft:cod", "minecraft:cow", "minecraft:creeper", "minecraft:dark_oak_boat", "minecraft:jungle_boat", "minecraft:mangrove_boat", "minecraft:oak_boat", "minecraft:pale_oak_boat", "minecraft:pufferfish", "minecraft:salmon", "minecraft:sheep", "minecraft:skeleton", "minecraft:spruce_boat", "minecraft:tnt", "minecraft:tropical_fish", "minecraft:zombie"}
