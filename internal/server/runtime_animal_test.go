...
func TestRuntimeEntityRegistryContainsImplementedEntities(t *testing.T) {
	wantNames := []string{"minecraft:arrow", "minecraft:chicken", "minecraft:cod", "minecraft:cow", "minecraft:creeper", "minecraft:salmon", "minecraft:sheep", "minecraft:skeleton", "minecraft:tnt", "minecraft:tropical_fish", "minecraft:zombie"}
