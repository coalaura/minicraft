...
const (
	...
	SoundEntityBatAmbient      SoundEvent = "minecraft:entity.bat.ambient"
	SoundEntityBatDeath        SoundEvent = "minecraft:entity.bat.death"
	SoundEntityBatHurt         SoundEvent = "minecraft:entity.bat.hurt"
	SoundEntityBatTakeoff      SoundEvent = "minecraft:entity.bat.takeoff"
	SoundEntityCowAmbient      SoundEvent = "minecraft:entity.cow.ambient"
	SoundEntityCowDeath        SoundEvent = "minecraft:entity.cow.death"
	SoundEntityCowHurt         SoundEvent = "minecraft:entity.cow.hurt"
	SoundEntityCowMilk         SoundEvent = "minecraft:entity.cow.milk"
	SoundEntityCowStep         SoundEvent = "minecraft:entity.cow.step"
	SoundEntitySheepAmbient    SoundEvent = "minecraft:entity.sheep.ambient"
	SoundEntitySheepDeath      SoundEvent = "minecraft:entity.sheep.death"
	SoundEntitySheepHurt       SoundEvent = "minecraft:entity.sheep.hurt"
	SoundEntitySheepShear      SoundEvent = "minecraft:entity.sheep.shear"
	SoundEntitySheepStep       SoundEvent = "minecraft:entity.sheep.step"
	SoundEntityChickenAmbient  SoundEvent = "minecraft:entity.chicken.ambient"
	SoundEntityChickenDeath    SoundEvent = "minecraft:entity.chicken.death"
	...
	SoundEntitySkeletonAmbient SoundEvent = "minecraft:entity.skeleton.ambient"
	SoundEntitySkeletonDeath   SoundEvent = "minecraft:entity.skeleton.death"
